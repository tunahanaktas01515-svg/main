...
export const BACKGROUNDS: BgOption[] = [
  { id: 'glass', label: 'Işıltı', bg: "url('/glass-bg.png') center / cover no-repeat fixed", thumb: "url('/glass-bg.png') center / cover" },
  ...
  { id: 'mountains', label: 'Dağlar', bg: "linear-gradient(180deg, rgba(8,9,12,0.35), rgba(6,7,10,0.7)), url('/mountains-bg.png') center / cover no-repeat fixed", thumb: "url('/mountains-bg.png') center / cover" },
];
