...
export default function ContactSection() {
  ...
  const mailHref = `mailto:${CONTACT.email}?subject=Cenan%20AI%20İletişim`

  return (
    <section className="contact" id="iletisim">
      <h2 className="contact__title">İletişim</h2>
      <p className="contact__sub">
        Arama ile bizi arayın, WhatsApp’tan yazın veya e-posta gönderin.
      </p>

      <div className="contact__icons">
        <a className="contact__btn" href={telHref} aria-label="Telefon ile ara">
        ...
        <a className="contact__btn" href={mailHref} aria-label="E-posta gönder">
          <span className="contact__icon" aria-hidden="true">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
